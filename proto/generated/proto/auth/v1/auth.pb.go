...
func (x *SigninUserResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_proto_auth_v1_auth_proto_rawDesc = "" +
	...
	"\faccess_token\x18\x02 \x01(\tR\vaccessToken\"E\n" +
	"\x11SigninUserRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"Q\n" +
	"\x12SigninUserResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12!\n" +
	"\faccess_token\x18\x02 \x01(\tR\vaccessToken2\xa5\x01\n" +
	"\vAuthService\x12M\n" +
	"\fRegisterUser\x12\x1c.auth.v1.RegisterUserRequest\x1a\x1d.auth.v1.RegisterUserResponse\"\x00\x12G\n" +
	"\n" +
	"SigninUser\x12\x1a.auth.v1.SigninUserRequest\x1a\x1b.auth.v1.SigninUserResponse\"\x00B,Z*distributed-media-processing-platform/authb\x06proto3"
...
var file_proto_auth_v1_auth_proto_goTypes = []any{
	...
	(*SigninUserRequest)(nil),    // 2: auth.v1.SigninUserRequest
	(*SigninUserResponse)(nil),   // 3: auth.v1.SigninUserResponse
}
var file_proto_auth_v1_auth_proto_depIdxs = []int32{
	...
	2, // 1: auth.v1.AuthService.SigninUser:input_type -> auth.v1.SigninUserRequest
	1, // 2: auth.v1.AuthService.RegisterUser:output_type -> auth.v1.RegisterUserResponse
	3, // 3: auth.v1.AuthService.SigninUser:output_type -> auth.v1.SigninUserResponse
